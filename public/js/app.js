...
/* harmony default export */ __webpack_exports__["a"] = {
    handleValidationErrors: function handleValidationErrors(response, callback) {
    ...
    showValidationErrors: function showValidationErrors(response) {
        ...
        try {
            for (var _iterator = Object.entries(response.data)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var _step$value = _slicedToArray(_step.value, 2),
                    key = _step$value[0],
                    value = _step$value[1];

                $('[name="' + key + '"]').parent().addClass('md-input-invalid').find('.md-error').text(value);
            }
        } catch (err) {
    ...
    redirectUserIfRequired: function redirectUserIfRequired(response) {
    ...
    showAlert: function showAlert(response, callback) {
    ...
    handleServerError: function handleServerError(response) {
        var customText = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
    ...
    showInfoModal: function showInfoModal(title, text) {
        swal({
            title: title,
            text: text,
            type: 'info',
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony default export */ __webpack_exports__["a"] = {
    constructor: function constructor() {
        this.videoDimensions, this.$video, this.$canvas;
    },
    init: function init() {
    ...
    getVideoElementDimensions: function getVideoElementDimensions() {
    ...
    drawAndDisplayCanvas: function drawAndDisplayCanvas() {

        var w = this.videoDimensions.w,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_AuthCard__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_AuthCard___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_AuthCard__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_QuickAction__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_QuickAction___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_QuickAction__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_SecureCloud__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_SecureCloud___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_SecureCloud__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_FileSearch__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_FileSearch___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_FileSearch__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__support_Ajax__ = __webpack_require__(3);
// requires
var Vue = __webpack_require__(4);
var VueMaterial = __webpack_require__(26);
var VueResource = __webpack_require__(27);
...
new Vue({
    el: 'main',
    methods: {
        deleteShareByHash: function deleteShareByHash(hash) {

            // fetch new files
            this.$http.post('/share/delete/' + hash).then(function (response) {
                __WEBPACK_IMPORTED_MODULE_4__support_Ajax__["a" /* default */].showAlert(response);
                $('[data-fileshare-hash="' + hash + '"]').slideUp("slow");
            }, function (response) {
                __WEBPACK_IMPORTED_MODULE_4__support_Ajax__["a" /* default */].handleServerError(response);
            });
        }
    },
    components: {
        'auth-card': __WEBPACK_IMPORTED_MODULE_0__components_AuthCard___default.a,
        'quick-action': __WEBPACK_IMPORTED_MODULE_1__components_QuickAction___default.a,
        'secure-cloud': __WEBPACK_IMPORTED_MODULE_2__components_SecureCloud___default.a,
        'file-search': __WEBPACK_IMPORTED_MODULE_3__components_FileSearch___default.a
    }
});
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(0)))
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__support_Ajax__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__VueCamera__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__VueCamera___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__VueCamera__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__support_Camera__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__support_EventBus__ = __webpack_require__(1);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    methods: {
        ...
        registerUser: function registerUser() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].showLoader();

            this.formData.photo = __WEBPACK_IMPORTED_MODULE_2__support_Camera__["a" /* default */].exportImage();

            this.$http.post('/register', this.formData).then(function (response) {
                __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].showAlert(response, __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].redirectUserIfRequired(response));
            }, function (response) {
                __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].handleValidationErrors(response);
                __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].handleServerError(response);
            });
        },
        ...
        loginUser: function loginUser() {
            ...
            this.$http.post('/login', this.formData).then(function (response) {
                ...
                __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].showAlert(response, function () {
        ...
        loginWithPassword: function loginWithPassword() {
            ...
            this.$http.post('/login/password', this.formData).then(function (response) {
                __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].showAlert(response, __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].redirectUserIfRequired(response));
            }, function (response) {
                __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].handleValidationErrors(response);
                __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].showAlert(response);
            });
        },

        showLoginStep2: function showLoginStep2() {
    ...
    components: {
        'vue-camera': __WEBPACK_IMPORTED_MODULE_1__VueCamera___default.a
    },

    created: function created() {

        // catch login event
        __WEBPACK_IMPORTED_MODULE_3__support_EventBus__["a" /* EventBus */].$on('do-login', this.loginUser);
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__support_EventBus__ = __webpack_require__(1);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    methods: {
        ...
        emitQuery: function emitQuery(string) {

            this.isActive = string.length > 0 ? true : false;

            __WEBPACK_IMPORTED_MODULE_0__support_EventBus__["a" /* EventBus */].$emit('search-files', string);
        },

        toggleClass: function toggleClass() {
            console.debug("toggle class");
        }
...
/* WEBPACK VAR INJECTION */(function($) {Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__support_Ajax__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__support_EventBus__ = __webpack_require__(1);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    methods: {
        ...
        uploadFiles: function uploadFiles(value) {
            ...
            this.$http.post('/file/upload', formData, {
                ...
                __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].handleServerError(response, "Folgende Dateien sind zu groß für den Upload: <br>" + this.notUploaded.join(', '));
            });
        },

        refreshView: function refreshView(response) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__support_EventBus__["a" /* EventBus */].$emit('fetch-files');
        }
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    methods: {
        ...
        changeFileSelection: function changeFileSelection(id, file_name) {
        ...
        deleteFiles: function deleteFiles() {
            ...
            if (this.selected.length == 0) {
                return __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].showInfoModal('Keine Dateien ausgewählt', '');
            }

            this.$http.post('/file/delete', JSON.stringify(this.selected)).then(function (response) {
        ...
        shareFiles: function shareFiles() {
            ...
            // create file share
            this.$http.post('/share/create', JSON.stringify(this.selected)).then(function (response) {
                __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].showAlert(response);
        ...
        chooseFilesToShare: function chooseFilesToShare() {
            __WEBPACK_IMPORTED_MODULE_0__support_Ajax__["a" /* default */].showInfoModal('Keine Dateien ausgewählt', '<a id="go-to-shares" href="/share/index">Meine Dateifreigaben verwalten</a>');
        },

        // dirty implementing two-way data binding...
        clearFileSelection: function clearFileSelection() {
    ...
    created: function created() {
        ...
        __WEBPACK_IMPORTED_MODULE_1__support_EventBus__["a" /* EventBus */].$on('fetch-files', function () {
        ...
        __WEBPACK_IMPORTED_MODULE_1__support_EventBus__["a" /* EventBus */].$on('search-files', function (query) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__support_Camera__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__support_EventBus__ = __webpack_require__(1);
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    methods: {
        ...
        takePhoto: function takePhoto() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__support_Camera__["a" /* default */].takePhoto();

            if (this.type == 'login') {
                __WEBPACK_IMPORTED_MODULE_1__support_EventBus__["a" /* EventBus */].$emit('do-login');
            }
        },
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__support_Camera__["a" /* default */].init();
    },
    created: function created() {
...
Component.options.__file = "C:\\dev\\privat\\face-login\\resources\\assets\\js\\components\\AuthCard.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] AuthCard.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-38f763b6", Component.options)
  } else {
    hotAPI.reload("data-v-38f763b6", Component.options)
  }
})()}
...
Component.options.__file = "C:\\dev\\privat\\face-login\\resources\\assets\\js\\components\\FileSearch.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] FileSearch.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-40766051", Component.options)
  } else {
    hotAPI.reload("data-v-40766051", Component.options)
  }
})()}
...
Component.options.__file = "C:\\dev\\privat\\face-login\\resources\\assets\\js\\components\\QuickAction.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] QuickAction.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4660dcc6", Component.options)
  } else {
    hotAPI.reload("data-v-4660dcc6", Component.options)
  }
})()}
...
Component.options.__file = "C:\\dev\\privat\\face-login\\resources\\assets\\js\\components\\SecureCloud.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] SecureCloud.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-888cbc7e", Component.options)
  } else {
    hotAPI.reload("data-v-888cbc7e", Component.options)
  }
})()}
...
Component.options.__file = "C:\\dev\\privat\\face-login\\resources\\assets\\js\\components\\VueCamera.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] VueCamera.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8195cd64", Component.options)
  } else {
    hotAPI.reload("data-v-8195cd64", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('md-whiteframe', {
  ...
  }), _vm._v(" "), _c('form', [_c('header', {
    staticClass: "md-primary"
  }, [(this.type == 'login') ? _c('h2', [_vm._v("Login")]) : _c('h2', [_vm._v("Registrierung")]), _vm._v(" "), (_vm.type == 'login') ? _c('md-button', {
  ...
  }, [_vm._v("Registrieren")])], 1) : _vm._e()], 1), _vm._v(" "), _c('md-layout', {
    staticClass: "content",
    attrs: {
      "md-gutter": ""
    }
  ...
  }, [(_vm.type != 'register') ? _c('div', [_c('md-input-container', [_c('label', [_vm._v("Username")]), _vm._v(" "), _c('md-input', {
    attrs: {
      "name": "name",
      "autocomplete": "off"
    },
  ...
  })], 1)], 1) : _vm._e(), _vm._v(" "), _c('vue-camera', {
    attrs: {
      "type": _vm.type
    }
  }), _vm._v(" "), _c('input', {
  ...
  }, [_c('label', [_vm._v("Passwort")]), _vm._v(" "), _c('md-input', {
    attrs: {
      "type": "password",
      "name": "password"
    },
    ...
    staticClass: "md-error"
  })], 1)], 1), _vm._v(" "), (_vm.type == 'register') ? _c('md-layout', {
    attrs: {
      "md-column": "",
      "id": "user-data"
    }
    ...
    staticClass: "md-error"
  })], 1), _vm._v(" "), _c('md-input-container', [_c('label', [_vm._v("Passwort")]), _vm._v(" "), _c('md-input', {
    attrs: {
      "type": "password",
      "name": "password"
    },
    ...
    staticClass: "md-error"
  })], 1), _vm._v(" "), _c('md-input-container', [_c('label', [_vm._v("Passwort bestätigen")]), _vm._v(" "), _c('md-input', {
    attrs: {
      "type": "password",
    ...
    model: {
      ...
      callback: function($$v) {
        _vm.formData.passwordConfirm = $$v
      }
    }
  }), _vm._v(" "), _c('span', {
    staticClass: "md-error"
  ...
  }, [_c('md-icon', [_vm._v("send")])], 1)], 1) : _c('div', [_c('md-button', {
    staticClass: "md-fab md-accent",
    attrs: {
      "id": "login-button"
    },
    nativeOn: {
      "click": function($event) {
        _vm.loginWithPassword($event)
      }
    }
  }, [_c('md-icon', [_vm._v("send")])], 1)], 1)], 1)], 1)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-38f763b6", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('md-icon', [_vm._v("search")]), _vm._v(" "), _c('label', [_vm._v("Search")]), _vm._v(" "), _c('md-input', {
    attrs: {
      "type": "text"
    },
    on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-40766051", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    nativeOn: {
      "click": function($event) {
        _vm.triggerFileUpload($event)
      }
    }
  }, [_c('md-icon', [_vm._v("cloud_upload")])], 1), _vm._v(" "), _c('md-spinner', {
    attrs: {
      "id": "uploading-files",
      "md-size": 74,
      "md-stroke": 2.2,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4660dcc6", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Tipp: Mit Leertaste kannst du das Foto auch aufnehmen.")])], 1)], 1)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-8195cd64", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('header', [(!_vm.isShare) ? _c('h1', [_vm._v("Meine Dateien")]) : _c('h1', [_vm._v("Dateifreigabe von " + _vm._s(this.userName))]), _vm._v(" "), (!_vm.isShare) ? _c('div', {
    attrs: {
      "id": "actions"
    }
  }, [_c('md-button', {
  ...
  }, [_vm._v("Löschen")])], 1), _vm._v(" "), _c('md-button', {
    staticClass: "md-primary",
    nativeOn: {
      "click": function($event) {
        _vm.shareFiles($event)
      }
    }
  }, [_c('md-icon', [_vm._v("share")]), _vm._v(" "), _c('md-tooltip', {
    attrs: {
      "md-direction": "top"
    }
  }, [_vm._v("Teilen")])], 1)], 1) : _vm._e()]), _vm._v(" "), (_vm.files.length == 0) ? _c('div', {
    attrs: {
      "id": "no-files"
    }
  }, [(!_vm.isShare) ? _c('p', [_vm._v("Fange an deine Dateien "), _c('span', {
    on: {
      "click": _vm.triggerFileUpload
    }
  }, [_vm._v("hochzuladen")])]) : _c('p', {
    staticStyle: {
      "text-align": "left"
    }
  }, [_vm._v("Anscheinend hat der Besitzer die Dateien bereits gelöscht...")])]) : _c('md-layout', {
    attrs: {
      "id": "my-files",
      "md-gutter": ""
    }
  }, _vm._l((_vm.files), function(file) {
    return (!_vm.searchMode || (_vm.searchMode && _vm.searchResult.includes(file.id))) ? _c('md-layout', [_c('md-card', [_c('md-card-media', [_vm._v("\n                    " + _vm._s(file.file_extension) + "\n                ")]), _vm._v(" "), _c('md-card-content', [_c('div', {
      staticClass: "filename"
    }, [(!_vm.isShare) ? _c('a', {
      attrs: {
        "href": '/file/download/' + file.file_name
      }
    }, [_vm._v("\n                            " + _vm._s(file.file_name_original.substr(
      0, file.file_name_original.length - file.file_extension.length - 1
    )) + "\n                        ")]) : _c('a', {
      attrs: {
        "href": '/file/download/' + file.file_name + '/share/' + _vm.shareId,
        "target": "_self"
      }
    }, [_vm._v("\n                            " + _vm._s(file.file_name_original.substr(
      0, file.file_name_original.length - file.file_extension.length - 1
      ...
      on: {
        "change": function($event) {
          _vm.changeFileSelection(file.id, file.file_name)
        }
      }
    })], 1) : _vm._e()])], 1)], 1) : _vm._e()
  }))], 1)
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-888cbc7e", module.exports)
  }
}
